use utf8;
package MandatoAberto::Schema::Result::PoliticianChatbot;
...
=head1 TABLE: C<politician_chatbot>

=cut

__PACKAGE__->table("politician_chatbot");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:6CXZQL2ele+4qKNDqwV9XA

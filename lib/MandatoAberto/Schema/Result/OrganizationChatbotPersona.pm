use utf8;
package MandatoAberto::Schema::Result::OrganizationChatbotPersona;
...
=head1 TABLE: C<organization_chatbot_persona>

=cut

__PACKAGE__->table("organization_chatbot_persona");
...
=head2 id
  ...
  is_auto_increment: 1
  is_nullable: 0
  sequence: 'organization_chatbot_persona_id_seq'

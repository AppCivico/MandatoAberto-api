...
=head2 politician_chatbot_dialogs

Type: has_many

Related object: L<MandatoAberto::Schema::Result::PoliticianChatbotDialog>

=cut

__PACKAGE__->has_many(
  "politician_chatbot_dialogs",
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:AjYMvJq8ozd6zGI7ya4K3w

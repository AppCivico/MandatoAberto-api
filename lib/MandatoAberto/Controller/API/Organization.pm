...
sub result_GET {
    ...
    return $self->status_ok(
        ...
        entity => {
            ...
            ( map { $_ => $organization->$_ } qw( id name premium premium_updated_at approved approved_at picture invite_token created_at updated_at has_email_broadcast fb_app_id ) ),
